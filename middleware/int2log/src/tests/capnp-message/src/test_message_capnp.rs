...
pub mod test_message {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(200, 168, 114, 74, 163, 30, 236, 198),
      ::capnp::word(19, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(183, 125, 106, 87, 53, 89, 24, 182),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(116, 101, 115, 116, 95, 109, 101, 115),
      ::capnp::word(115, 97, 103, 101, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 84, 101, 115, 116, 77),
    ...
    pub const TYPE_ID: u64 = 0xc6ec_1ea3_4a72_a8c8;
  }
}
