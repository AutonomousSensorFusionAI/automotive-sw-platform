...
pub mod log_message {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_log_level(self) -> ::core::result::Result<crate::log_message_capnp::log_message::LogLevel,::capnp::NotInSchema> {
    ...
    #[inline]
    pub fn get_logger(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_log_level(&mut self, value: crate::log_message_capnp::log_message::LogLevel)  {
    ...
    #[inline]
    pub fn get_logger(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_logger(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false).unwrap()
    }
    #[inline]
    pub fn init_logger(self, size: u32) -> ::capnp::text::Builder<'a> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 84] = [
      ...
      ::capnp::word(0, 89, 197, 251, 132, 231, 26, 195),
      ::capnp::word(18, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(17, 40, 68, 199, 101, 97, 35, 202),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(108, 111, 103, 95, 109, 101, 115, 115),
      ::capnp::word(97, 103, 101, 46, 99, 97, 112, 110),
      ::capnp::word(112, 58, 76, 111, 103, 77, 101, 115),
      ::capnp::word(115, 97, 103, 101, 0, 0, 0, 0),
      ::capnp::word(4, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(191, 157, 49, 62, 124, 107, 203, 188),
      ::capnp::word(1, 0, 0, 0, 74, 0, 0, 0),
      ::capnp::word(76, 111, 103, 76, 101, 118, 101, 108),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(108, 111, 103, 76, 101, 118, 101, 108),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(108, 111, 103, 103, 101, 114, 0, 0),
      ::capnp::word(12, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <crate::log_message_capnp::log_message::LogLevel as ::capnp::introspect::Introspect>::introspect(),
  ...
  impl ::capnp::introspect::Introspect for LogLevel {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema { encoded_node: &log_level::ENCODED_NODE, annotation_types: log_level::get_annotation_types }).into() }
  }
  impl <'a> ::core::convert::From<LogLevel> for ::capnp::dynamic_value::Reader<'a> {
    fn from(e: LogLevel) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema { encoded_node: &log_level::ENCODED_NODE, annotation_types: log_level::get_annotation_types }.into()).into() }
  }
  impl ::core::convert::TryFrom<u16> for LogLevel {
    type Error = ::capnp::NotInSchema;
    fn try_from(value: u16) -> ::core::result::Result<Self, <LogLevel as ::core::convert::TryFrom<u16>>::Error> {
      match value {
        0 => ::core::result::Result::Ok(Self::Trace),
        1 => ::core::result::Result::Ok(Self::Debug),
        2 => ::core::result::Result::Ok(Self::Info),
        3 => ::core::result::Result::Ok(Self::Warn),
        4 => ::core::result::Result::Ok(Self::Error),
        n => ::core::result::Result::Err(::capnp::NotInSchema(n)),
      }
    }
  }
  impl From<LogLevel> for u16 {
    #[inline]
    fn from(x: LogLevel) -> u16 { x as u16 }
  }
  impl ::capnp::traits::HasTypeId for LogLevel {
    const TYPE_ID: u64 = 0xbccb_6b7c_3e31_9dbfu64;
  }
  mod log_level {
  pub static ENCODED_NODE: [::capnp::Word; 39] = [
    ...
    ::capnp::word(97, 103, 101, 46, 99, 97, 112, 110),
    ::capnp::word(112, 58, 76, 111, 103, 77, 101, 115),
    ::capnp::word(115, 97, 103, 101, 46, 76, 111, 103),
    ::capnp::word(76, 101, 118, 101, 108, 0, 0, 0),
